...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-metatensor-learn-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-metatensor-learn-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-metatensor-learn
# for installing globally
pixi global install python-metatensor-learn
```
...
It is possible to list all of the versions of `python-metatensor-learn` available on your platform:
...
```
pixi search python-metatensor-learn --channel conda-forge
```
